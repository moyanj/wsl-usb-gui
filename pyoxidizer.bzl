...
def make_exe():
    ...
    # platforms.
    policy.allow_in_memory_shared_library_loading = False  # doesn't work with wx
    ...
    python_config.run_module = "wsl_usb_gui"
...
def make_msi(exe):
    ...
    # https://pyoxidizer.readthedocs.io/en/stable/tugger_starlark_type_wix_msi_builder.html
